...
const SetupRooms = () => {
    ...
    useEffect(() => {
        api.get('schools/my_school/')
            ...
            .catch(() => console.log("Brak sal do wczytania"))
    ...
    return (
        <div style={styles.container}>
            ...
            <div style={styles.headerRow}>
                ...
                {isEditMode && <div style={{width: '24px'}}></div>} {/* Pusty div dla RWD */}
            </div>

            <div style={styles.card}>
                <form onSubmit={handleSubmit}>
                    <div style={styles.checkboxContainer} onClick={() => setOnlyOneRoom(!onlyOneRoom)}>
...
const styles = {
    ...
    inputGroup: { display: 'flex', alignItems: 'flex-end', gap: '10px', marginBottom: '15px' },
    label: { display: 'block', fontSize: '14px', marginBottom: '8px', color: '#434343', fontWeight: '600' },
    input: { width: '100%', padding: '12px', border: '1px solid #E0E0E0', borderRadius: '6px' },
    ...
    errorText: { color: '#ff4d4f', fontSize: '12px', marginTop: '15px', textAlign: 'center' },
